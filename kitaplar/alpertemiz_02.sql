...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 22 Ara 2020, 14:26:15
...
INSERT INTO `kitap` (`kitapNo`, `kitapKayitTarih`, `kitapAdi`, `ISBN`, `kitapBasimYer`, `kitapBasimTarih`, `yayineviKayitNo`, `yazarKayitNo`) VALUES
...
--
ALTER TABLE `kitap`
  MODIFY `kitapNo` smallint(6) NOT NULL AUTO_INCREMENT COMMENT 'Kitap tablosunun ana anahtarı';
--
-- Tablo için AUTO_INCREMENT değeri `yayınevi`
--
ALTER TABLE `yayınevi`
  MODIFY `yayineviKayitNo` smallint(11) NOT NULL AUTO_INCREMENT COMMENT 'Yayınevi Numarası Bilgisi', AUTO_INCREMENT=11;
--
-- Tablo için AUTO_INCREMENT değeri `yazar`
--
ALTER TABLE `yazar`
  MODIFY `yazarKayitNo` smallint(11) NOT NULL AUTO_INCREMENT COMMENT 'yazar numara bilgisi', AUTO_INCREMENT=11;
