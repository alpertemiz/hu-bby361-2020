<?php
    ...
    $sorgu = "INSERT INTO kitap (kitapAdi, ISBN, kitapBasimYer, kitapBasimTarih, yazarKayitNo, yayineviKayitNo)
            VALUES ('$kitapAdi', '$ISBN', '$kitapBasimYer', '$kitapBasimTarih', '$yazarKayitNo', '$yayineviKayitNo')";
    ...
    $sorgu = mysqli_query($baglanti, "SELECT * FROM kitap ORDER BY kitapNo DESC");
