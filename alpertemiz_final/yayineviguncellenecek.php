...
<h1>Yayınevi Güncelle</h1>
        <form action="yayinevi_guncellendi.php" method="post">
            Yayınevi Adı: <input type="text" value="<?php echo $satir["yayineviAdi"] ;?>" name="yayineviAdi"><br>
            Yayınevi URL: <input type="text" value="<?php echo $satir["yayineviURL"] ;?>" name="yayineviURL"><br>
