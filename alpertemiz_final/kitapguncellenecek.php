...
<h1>Kitap Güncelle</h1>
        <form action="kitap_guncellendi.php" method="post">
            ...
            Kitap ISBN: <input type="text" value="<?php echo $satir["ISBN"] ;?>" name="ISBN"><br>
            Kitap Basım Yeri: <input type="text" value="<?php echo $satir["kitapBasimYer"] ;?>" name="kitapBasimYer"><br>
