<?php
    ...
    $sorgu2 = mysqli_query($baglanti, "SELECT * FROM yayınevi ORDER BY yayineviKayitNo DESC");
...
echo("<table border=1 width=80%>");
    echo("<tr>");
    echo("<td><b>Yayinevi Kayıt No</b></td>");
    echo("<td><b>Yayınevi Kayıt Tarih</b></td>");
...
while($satir = mysqli_fetch_assoc($sorgu2)){
    ...
    echo("<td><a href='yayineviguncellenecek.php?yayineviKayitNo=".$satir["yayineviKayitNo"]."'>Güncelle</a></td>");
