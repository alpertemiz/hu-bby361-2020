...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 03 Kas 2020, 17:11:00
...
--
CREATE DATABASE IF NOT EXISTS `alpertemiz_01` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `alpertemiz_01`;
...
INSERT INTO `kitap` (`KitapNo`, `KitapKayıtTarih`, `KitapAdı`, `ISBN`, `KitapBasımYer`, `KitapBasımTarih`) VALUES
(1, '2020-11-03 14:32:49', 'Kumarbaz', '9789750515477', 'İstanbul', 2014),
(4, '2020-11-03 15:44:01', 'Hayvan Çiftliği', '9789750719387', 'İstanbul', 1984),
(5, '2020-11-03 15:46:42', 'Körlük', '9786052980811', 'İstanbul', 2017),
(6, '2020-11-03 15:49:56', 'Son Cüret', '9786254440489', 'İstanbul', 2020),
(7, '2020-11-03 15:52:14', 'Fareler ve İnsanlar', '9789755705859', 'İstanbul', 2012),
(8, '2020-11-03 15:56:33', 'Kitapları Kurtaran Kedi', '9786057717610', 'İstanbul', 2014),
(9, '2020-11-03 15:59:17', 'Şeker Portakalı', '9789750738609', 'İstanbul', 2000),
(10, '2020-11-03 16:02:23', 'Son Sığınak', '9786257231022', 'İstanbul', 2020),
(11, '2020-11-03 16:05:08', 'Cesur Yeni Dünya', '9789756902165', 'İstanbul', 2003),
(12, '2020-11-03 16:07:22', 'Kendi Yatağımda Uyumayacağım!', '9786052169568', 'İstanbul', 2019);
...
--
ALTER TABLE `yayınevi`
  MODIFY `yayıneviKayıtNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Yayınevi Numarası Bilgisi', AUTO_INCREMENT=11;
--
-- Tablo için AUTO_INCREMENT değeri `yazar`
--
ALTER TABLE `yazar`
  MODIFY `yazarKayıtNo` int(11) NOT NULL AUTO_INCREMENT COMMENT 'yazar numara bilgisi', AUTO_INCREMENT=11;
